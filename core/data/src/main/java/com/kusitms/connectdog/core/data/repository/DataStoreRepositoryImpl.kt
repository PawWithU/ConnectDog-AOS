...
class DataStoreRepositoryImpl @Inject constructor(
    ...
    override suspend fun getFcmToken(): Flow<String?> = context.dataStore.data.map { preferences ->
        preferences[PreferenceKeys.fcmToken]
    }

    override suspend fun getRefreshToken(): Flow<String?> = context.dataStore.data.map { preferences ->
        preferences[PreferenceKeys.refreshToken]
    }

    override suspend fun getAccessToken(): Flow<String?> = context.dataStore.data.map { preferences ->
        preferences[PreferenceKeys.accessToken]
    }

    override suspend fun getAppMode(): Flow<AppMode> = context.dataStore.data
        .map { preferences ->
    ...
    override suspend fun getSocialToken(): Flow<String?> = context.dataStore.data.map { preferences ->
