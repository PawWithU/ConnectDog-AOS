...
class CertificationViewModel
    @Inject
    constructor() : ContainerHost<CertificationUiState, CertificationSideEffect>, ViewModel() {
        ...
        fun onChangeCertificationNumber(certificationNumber: String) =
            intent {
        ...
        private fun enableCertificationButton() =
            intent {
